    ...
    <main className="relative w-full min-h-screen bg-[#F6F1EE] text-gray-100 font-sans">
        ...
        <div className="max-w mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex space-x-4 text-[#F6F1EE] dia">
              ...
              <a href="#search-transaction" className="hover:text-gray-300 hover:underline">Search Transaction</a>
      ...
      <div className='text-center relative z-10 w-3/4 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 px-4'>
        ...
        <div className="dia max-w-screen-xl mx-auto mt-8 grid grid-cols-2 gap-8">
                ...
                <div className="bg-[#766387]/30 hover:bg-[#87729c]/30 backdrop-blur-lg backdrop-brightness-125 p-8 rounded-lg transition-transform transform hover:scale-105">
        ...
        <div className=''>
              ...
              <div className='dia flex items-center justify-center'>
                <div className='relative w-full'>
                  <input
                    ...
                    className="mt-8 p-4 transition-transform transform hover:scale-105 placeholder:text-center rounded-lg bg-[#766387]/30 hover:bg-[#87729c]/30 text-white placeholder-white w-full"
                  />
                </div>
                <button
                  onClick={handleSearch}
                  className="dia mt-8 ml-2 px-4 py-4 bg-white-500 text-xs text-white rounded-lg hover:bg-[#292a2b]">
            ...
            {!transactionData && !transactionError ? (
              <div className="dia min-h-[205px] flex items-center justify-center relative text-center mt-9 p-8 bg-[#766387]/30 hover:bg-[#87729c]/30 backdrop-blur-lg backdrop-brightness-125 rounded-lg transition-transform transform hover:scale-105">
                <p className="font-display text-lg text-gray-300">Enter hash above to search</p>
              </div>
            ) : transactionError ? (
              <div className="min-h-[205px] flex items-center justify-center relative text-center mt-9 p-8 bg-[#766387]/30 hover:bg-[#87729c]/30 backdrop-blur-lg backdrop-brightness-125 rounded-lg transition-transform transform hover:scale-105">
                <p className="dia font-display text-lg text-red-500">{transactionError}</p>
              </div>
            ) : (
              <div className="dia relative text-center mt-9 p-8 bg-[#766387]/30 hover:bg-[#87729c]/30 backdrop-blur-lg backdrop-brightness-125 rounded-lg transition-transform transform hover:scale-105">
      ...
      <div id="latest-transactions" className='text-center relative z-10 w-3/4 mx-auto grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-8 px-4'>
        <div className=''>
          ...
          <h2 className="marfo text-center text-5xl font-bold text-[#11100F] hover:underline font-display">Latest Transactions</h2>
            <div className="dia transition-transform transform hover:scale-105 mx-auto mt-8 ">
              <table className="mt-8 min-w-full bg-[#766387]/30 hover:bg-[#87729c]/30 backdrop-blur-lg backdrop-brightness-125 rounded-lg text-white transition-transform transform">
                <thead>
                  <tr>
